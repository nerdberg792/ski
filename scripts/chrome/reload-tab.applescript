-- Reload a specific Chrome tab by window ID and tab index
...
try
	...
	tell application "Google Chrome"
		...
		tell active tab of targetWindow to reload
	end tell

	return "Reloaded Chrome tab " & tabIndexValue & " in window " & windowIdValue
